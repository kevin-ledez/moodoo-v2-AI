...
class HomeController extends AbstractController
{
    ...
    public function category(string $slug, Request $request, CategoryRepository $categoryRepository, PostRepository $postRepository): Response
    {
    ...
    public function post(string $slug, PostRepository $postRepository, CategoryRepository $categoryRepository): Response
    {
